...
% plot Phase difference of B E and Vbeam
if(S==3)
%%%%%%%
phi_Bx_Vix = mod((angle(Pola_norm(:,1,1,4))-angle(dV(:,1,2,1)))*180/pi+360,360);
% phi_Bx_Vix = (angle(Pola_norm(:,1,1,4))-angle(dV(:,1,1,1)))*180/pi;
phi_By_Viy = mod((angle(Pola_norm(:,1,1,5))-angle(dV(:,2,2,1)))*180/pi+360,360);
phi_Bz_Viz = mod((angle(Pola_norm(:,1,1,6))-angle(dV(:,3,2,1)))*180/pi+360,360);
phi_Ex_Vix = mod((angle(Pola_norm(:,1,1,1))-angle(dV(:,1,2,1)))*180/pi+360,360);
phi_Ey_Viy = mod((angle(Pola_norm(:,1,1,2))-angle(dV(:,2,2,1)))*180/pi+360,360);
phi_Ez_Viz = mod((angle(Pola_norm(:,1,1,3))-angle(dV(:,3,2,1)))*180/pi+360,360);
...
print(h3,'-dpng',[savepath,'fig_pdrk_',figstr,'_BEVibeampola.png']);
savefig([savepath,'fig_pdrk_',figstr,'_BEVibeampola.fig']);